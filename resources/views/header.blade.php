                ...
                <div class="vdb-rb-container">
                    <div class="vdb-rb-steps-container">
                        <div class="vdb-rb-steps-wrap " style=" @if (request()->routeIs('select') || request()->routeIs('index') || request()->routeIs('fetched_data')) background-color:grey;border-radius: 100px;padding: 5px 50px 5px 50px;  @else background-color:rgb(219, 190, 190);border-radius: 100px;padding: 5px 50px 5px 50px; @endif">
                                ...
                                <a href="{{ route('index') }}">
                                    ...
                                    <div class="vdb-rb-steps-name vdb-rb-only-desktop">Choose <span>Stone</span>
                                        <div style="float: right;padding-right:5px">
                                            ...
                                            <a href="{{ url('api/select') }}/{{ session('certificate') }}">view</a>|
                            ...
                            <div class="vdb-rb-steps-wrap " style="@if (request()->routeIs('settings')  || request()->routeIs('confirm') || request()->routeIs('destroy_ring')|| request()->routeIs('Ring-settings') )  background-color:grey;border-radius: 100px;padding:5px 50px 5px 50px;  @else background-color:rgb(219, 190, 190);border-radius:100px;padding: 5px 50px 5px 50px;@endif ">
                                <div class="vdb-rb-steps-name-with-number">
                                    ...
                                    <div class="vdb-rb-steps-name vdb-rb-only-desktop">Choose<span>Setting</span>
                                        <div style="float: right;padding-right:5px">
                                            ...
                                            <a href="{{ url('api/confirm-setting') }}">view</a>|
                                            <a href="{{ url('api/settings/') }}">Change</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="vdb-rb-steps-wrap " style="@if (request()->routeIs('Select_setting')) background-color:grey;border-radius: 100px;padding:5px 50px 5px 50px;  @else background-color:rgb(219, 190, 190);border-radius:100px;padding: 5px 50px 5px 50px;@endif ">
