                ...
                <ul id="vdbrb_shape_filter_slider_natural" class="slick-initialized slick-slider" style="">
                    ...
                    <div class="slick-list draggable">
                        <div class="slick-track"
                            ...
                            <div class="slick-slide " data-slick-index="6" aria-hidden="false" style="width: 69px;">
                                <div>
                                    <li style="width: 100%; display: inline-block;">
        ...
        <div class="vdb-rb-col-md-6 ">
            <div class="vdb-rb-filter-options-block">
                ...
                <div class="vdb-rb-filter-range-slider vdbrb_natural_color vdbrb_natural_white_color" style="">
                    <ul id="vdbrb_shape_filter_slider_natural" class="slick-initialized slick-slider" style=""><button
        ...
        <div class="vdb-rb-col-md-6 ">
            <div class="vdb-rb-filter-options-block">
                ...
                <div class="vdb-rb-filter-range-slider vdbrb_natural_color vdbrb_natural_white_color" style="">
                    ...
                    <div>
                        <input type="number" min="300" max="30000" oninput="validity.valid||(value='0 ');"
                            id="min_price" class="price-range-field" width="80px" style="width:80px" disabled />.$
                        <p style="float: right"> <input type="number" min="300" max="30000"
                                oninput="validity.valid||(value='30000');" id="max_price" class="price-range-field"
                                style="width:80px" disabled />.$</p>
                    </div>
                </div>
            </div>
        </div>
