@include('header');
    ...
    <div class="PageContainer">
        <main id="main" role="main">
            ...
            <div id="vdbrb_main_page_cover"
                style="position: fixed; height: 100vh; width: 100%; top: 0px; left: 0px; background: rgb(255, 255, 255); z-index: 9999; display: none;">
                    ...
                    <div class="vdb-rb-steps-container">
                        <div class="vdb-rb-steps-wrap vdb-rb-active-step">
                            <div class="vdb-rb-steps-block vdb-rb-steps-1" onclick="vdbrb_view_selected_stone()">
                                ...
                                <div class="vdb-rb-steps-icon vdb-rb-stone-icon"><span
                                        class="vdb-rb-icon vdb-rb-icon-mainmenu_switch_diamond"></span></div>
                            </div>
                        ...
                        <div class="vdb-rb-steps-wrap ">
                            ...
                            <div class="vdb-rb-steps-block vdb-rb-steps-2" onclick="vdbrb_view_selected_ring()">
                                ...
                                <div class="vdb-rb-steps-icon"><span class="vdb-rb-icon vdb-rb-icon_engagement"></span>
                                </div>
                            </div>
                        ...
                        <div class="vdb-rb-steps-wrap ">
                            <div class="vdb-rb-steps-block vdb-rb-steps-3">
                                ...
                                <div class="vdb-rb-steps-icon"><span
                                        class="vdb-rb-icon vdb-rb-icon-engagement-Rings"></span></div>
                            </div>
                            ...
                            <div class="vdb-rb-col-md-12 ">
                                <div class="vdb-rb-filter-options-block vdb-rb-shape-options">
                                    ...
                                    <ul id="vdbrb_shape_filter_slider_natural" class="slick-initialized slick-slider"
                                        style=""><button class="slick-prev slick-arrow slick-disabled"
                                        ...
                                        <div class="slick-list draggable">
                                            <div class="slick-track"
                                                        ...
                                                        <li style="width: 100%; display: inline-block;">
                                                            <a>
                                                                <div
                                                                    ...
                                                                    <a title="Round" data-val="Round"
                                                                        class="shape_diamond" data-val="round">
                                                                        <img class="image_off"
                                                ...
                                                <div class="slick-slide">
                                                    <div>
                                                        <li style="width: 100%; display: inline-block;">
                                                            <a data-short_code="trilliant"
                                                                data-value_for_api="Trilliant"
                            ...
                            <div class="vdb-rb-col-md-6 hide-filter" style="display:none">
                                <div class="vdb-rb-filter-options-block">
                                    ...
                                    <div class="vdb-rb-filter-range-slider vdbrb_natural_color vdbrb_natural_white_color"
                                        ...
                                        <h5 class="vdb-rb-filter-options-title"
                                            style="display: inline-block;margin:auto;float:right;">
                                            <p data-val="{{ $lab }}" class="filter lab_diamond"
                                                style="margin-left: 5px">{{ $lab }}</p>
                                        </h5>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            <div class="vdb-rb-col-md-6 hide-filter" style="display:none">
                                <div class="vdb-rb-filter-options-block">
                                    ...
                                    <div class="vdb-rb-filter-range-slider vdbrb_natural_color vdbrb_natural_white_color"
                                        ...
                                        <h5 class="vdb-rb-filter-options-title"
                                            style="display: inline-block;margin:auto;float:right;">
                                            <p data-val="{{ $cut }}" class="filter cut_diamond"
                                                style="margin-left: 5px">{{ $cut }}</p>
                                        </h5>
                                        @endforeach
                                    </div>
                                </div>
                        ...
                        <div class="vdb-rb-filter-panel">
                            ...
                            <div id="vdbrb_main_advance_filter_mobile_labgrown" style="display: none;">
                                ...
                                <div class="vdb-rb-filter-options-block vdb-rb-open-modal_labgrown"
                                    ...
                                    <h5 class="vdb-rb-filter-options-title">Fluorescence <span
                                            class="vdb-rb-filters-count"
